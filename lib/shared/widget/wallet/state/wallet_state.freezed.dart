...
mixin _$WalletState {
  ...
  set balance(String value) => throw _privateConstructorUsedError;
  ...
  set isObscured(bool value) => throw _privateConstructorUsedError;
...
abstract class $WalletStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String balance, bool isLoading, bool isObscured});
}
...
class _$WalletStateImpl implements _WalletState {
  _$WalletStateImpl(
      {this.balance = "0", this.isLoading = true, this.isObscured = false});
  ...
  @override
  String toString() {
    return 'WalletState(balance: $balance, isLoading: $isLoading, isObscured: $isObscured)';
  }
...
abstract class _WalletState implements WalletState {
  factory _WalletState({String balance, bool isLoading, bool isObscured}) =
      _$WalletStateImpl;
